...
import { damageListColumns, DamagedStockItem } from "./column";
...
interface Props {
  data: DamagedStockItem[];
}

export const DamageListTable: React.FC<Props> = ({ data }) => {
  ...
  const handleExportToCsv = () => {
    ...
    exportToCsv(
      "damage-products-" + format(new Date(), "YMdHHmmss"),
      headers,
      rows
    );
  };
      ...
      <Table className="rounded-lg overflow-hidden">
        ...
        <TableBody>
          {table.getRowModel().rows?.length ? (
            ...
            <TableRow>
              <TableCell
                colSpan={damageListColumns.length}
